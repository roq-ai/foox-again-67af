  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Foox again - Where companies meet freelancers, transforming the way jobs are offered and talent is discovered."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1527192491265-7e15c55b1ed2?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxmcmVlbGFuY2Vyc3xlbnwwfHx8fDE2OTUzOTA3NTN8MA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Foox again - Where companies meet freelancers, transforming the way jobs are offered and talent is discovered.`}
            </Text>
            <Box
