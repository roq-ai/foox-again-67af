...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'Job Application Submission.create': {
    roles: ['admin', 'recruiter'],
    key: 'job_application',
    tenantPath: [],
    userPath: [],
  },
  'Job Application Shortlisted.update': {
    roles: ['admin', 'recruiter'],
    key: 'job_application_shortlisted',
    tenantPath: [],
    userPath: [],
  },
  'Job Application Approved.update': {
    roles: ['admin', 'recruiter'],
    key: 'job_application_approved',
    tenantPath: [],
    userPath: [],
  },
};
